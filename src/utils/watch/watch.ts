...
import { normalizeStartOptions, StartOption } from '../start.js'
import { GRACEFUL_SHUTDOWN } from './events.js'
import { normalizeIgnores } from './options.js'
import { spawnWatcher } from './watcher.js'

const forkPath = join(dirname(import.meta.url), './fastify.js')
